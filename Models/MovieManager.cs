...
namespace CinemaManager.Models
{
    ...
    {
        public static async Task<Movie> GetMoviesOnlineAsync(string title, string id, string date)
        {
            string key = "cbedc33";
        ...
        public static  List<Movie> GetMoviesDatabase()
        {
            ...
            while (reader.Read())
            {
                ...
                movie.Dubbed = reader.GetInt32(23).ToString();
        ...
        internal static void AddMovie(List<string> columnNames, List<string> values)
        {
